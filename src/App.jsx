...
function App () {
  return (
    <>
      <header className='grid lg:grid-cols-7 lg:grid-rows-[7fr_1fr]'>
        ...
        <div className='lg:col-start-5 lg:col-end-6 lg:row-start-2 lg:row-end-3 lg:z-[1]'>
        ...
        <article className='flex flex-col justify-center items-start gap-6 lg:px-28 lg:col-start-5 lg:col-end-8 lg:row-start-1 lg:row-end-3'>
          <h1 className='text-4xl font-bold'>Discover innovative ways to decorate</h1>
          ...
          <button className='flex items-center gap-6 uppercase lg:tracking-[0.8em] lg:hover:text-light-gray lg:hover:fill-light-gray'>
            Shop Now
            <span>
              <IconArrow />
            </span>
      ...
      <main className='grid lg:grid-cols-7'>
        ...
        <section className='flex flex-col justify-center items-start gap-6 lg:px-16 lg:col-start-3 lg:col-end-6'>
          <h2 className='text-3xl font-bold'>About our furniture</h2>
